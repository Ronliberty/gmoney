...
const stepsData: Step[] = [
  {
    ...
    content: "<p class='text-lg text-black'>Earn money with grocery partnerships! We handle account management tasks for you. Let's guide you through how it works.</p>",
    type: "info",
    ...
    content: `
      <ul class="space-y-3 text-left">
        <li class="flex items-start">
          ...
          <span class='text-black'>Join our partnership program</span>
        </li>
        <li class="flex items-start">
          <i class="fas fa-tasks text-green-600 mt-1 mr-3"></i>
          <span class='text-black'>We handle account management tasks for you</span>
        </li>
        <li class="flex items-start">
          <i class="fas fa-money-bill-wave text-green-600 mt-1 mr-3"></i>
          <span class='text-black'>Earn money effortlessly</span>
        </li>
      </ul>`,
    type: "info",
    ...
    content: `
      <ul class="space-y-3 text-left">
        <li class="flex items-start">
          ...
          <span class='text-black'>Hassle-free earnings with minimal effort</span>
        </li>
        <li class="flex items-start">
          <i class="fas fa-headset text-green-600 mt-1 mr-3"></i>
          <span class='text-black'>Dedicated support from our expert team</span>
        </li>
        <li class="flex items-start">
          <i class="fas fa-rocket text-green-600 mt-1 mr-3"></i>
          <span class='text-black'>Quick and simple onboarding process</span>
        </li>
        <li class="flex items-start">
          <i class="fas fa-shield-alt text-green-600 mt-1 mr-3"></i>
          <span class='text-black'>Secure and reliable payment system</span>
        </li>
      </ul>`,
    type: "info",
  ...
  },
  {
    ...
    content: "<p class='text-lg text-black'>Fill out your info below and select your country to get started with our partnership program!</p>",
    type: "form",
  ...
  {
    title: "Thank You!",
    content: "<p class='text-lg mb-4 text-black'>We've received your information. Our team will contact you shortly to guide you through the next steps.</p><p class='mb-2 text-black'>Get ready to start earning with our partnership program!</p>",
    type: "thankyou",
    image: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%2316a34a'%3E%3Cpath d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z'%3E%3C/path%3E%3C/svg%3E"
  }
];
